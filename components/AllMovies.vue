                    ...
                    <div class="p-3 flex flex-col gap-y-4">
                        <div class="flex justify-between">
                            ...
                            <span @click="item.showDropDowns = ! item.showDropDowns" class="flex items-center justify-center h-7 w-7 cursor-pointer hover:bg-gray-200 rounded-full relative">
                                ...
                                <ul v-show="item.showDropDowns" class="flex flex-col rounded-md overflow-hidden bg-gray-100 absolute w-min right-0 top-6 shadow-xl divide-y divide-gray-300 divide-dashed">
                                    <li class="flex items-center gap-x-2 px-3 py-2 hover:bg-gray-200">
